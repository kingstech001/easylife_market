...
export default function CreateProductPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container max-w-4xl mx-auto py-4 sm:py-8 sm:px-6">
        <motion.div
              ...
              <TabsContent value="details" className="mt-4 sm:mt-6">
                ...
                >
                  <Card className="border-0 shadow-sm bg-card/50 dark:bg-card/20">
                    ...
                    <CardContent className="space-y-4 sm:space-y-6 p-2 sm:px-6">
                      <FormField
              ...
              <TabsContent value="variants" className="mt-4 sm:mt-6">
                ...
                >
                  <Card className="border-0 shadow-sm bg-card/50 dark:bg-card/20">
                    ...
                    <CardContent className="space-y-4 sm:space-y-6 px-0 sm:px-6">
                      {supportsVariants ? (
                        watchedHasVariants ? (
