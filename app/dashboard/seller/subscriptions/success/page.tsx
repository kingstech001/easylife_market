        ...
        <div className="max-w-md w-full bg-card/95 backdrop-blur-md rounded-2xl shadow-2xl border border-border/50 p-8 text-center relative z-10">
          ...
          <div className="mt-6 p-4 bg-muted/20 rounded-lg border border-border/30">
            <p className="text-sm text-muted-foreground">
              Redirecting to subscriptions in <span className="font-bold text-[#0E5A43]">{countdown}</span> seconds...
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full bg-card/95 backdrop-blur-md rounded-2xl shadow-2xl border border-border/50 p-8 text-center relative z-10">
        ...
        <div className="bg-emerald-500/10 rounded-xl p-6 mb-6 space-y-4 border border-emerald-500/30">
          <div>
          ...
          {productLimit !== null && (
            <div className="border-t border-border/30 pt-4 space-y-3">
              <div className="flex justify-between items-center text-sm">
                ...
                <span className="font-bold text-lg text-[#0E5A43]">
