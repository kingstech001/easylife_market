  ...
  const handleEnableLocation = async () => {
    ...
    try {
      if (isSlowNetwork()) {
        setIsLoading(false);
        setError(
          "Your connection looks weak. Please try again when the network is stronger.",
        );
        return;
      }
      ...
      navigator.geolocation.getCurrentPosition(
        async (position) => {
          ...
          try {
            ...
            console.log(
              "Location not saved to server (user may not be logged in)",
            );
          }
              ...
              <Card className="border-border/40 shadow-2xl">
                <CardHeader className="relative pb-3 sm:pb-4 px-4 sm:px-6 pt-4 sm:pt-6">
                  ...
                  <CardDescription className="text-xs sm:text-sm leading-relaxed">
                    Help us provide accurate delivery estimates and find stores
                    near you
                  </CardDescription>
                </CardHeader>
                ...
                <CardContent className="space-y-3 sm:space-y-4 px-4 sm:px-6 pb-4 sm:pb-6">
                  ...
                  <div className="space-y-2.5 sm:space-y-3">
                    ...
                    <div className="flex items-start gap-2 sm:gap-3 text-xs sm:text-sm text-muted-foreground">
                      ...
                      <span className="leading-relaxed">
                        Discover stores and products near you
                      </span>
                    </div>
                  </div>
                  ...
                  <p className="text-[10px] sm:text-xs text-center text-muted-foreground leading-relaxed px-2">
                    Your location data is stored securely and never shared with
                    third parties
                  </p>
                </CardContent>
              </Card>
