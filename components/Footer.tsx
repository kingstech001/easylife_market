...
import { Github, Twitter, Linkedin, Mail, Heart, ArrowUp, ShoppingBag, Send, MapPin, Phone, Clock, Star, Award } from "lucide-react"
...
export function ModernFooter() {
    ...
    const socialLinks = [
        { icon: Github, href: "#", label: "GitHub", color: "hover:text-[#333] dark:hover:text-white" },
    ...
    return (
        <footer className="relative bg-gradient-to-b from-background via-muted/10 to-background border-t border-border/50 overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute bottom-[10%] right-[10%] w-56 h-56 sm:w-72 sm:h-72 bg-primary/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
            </div>
                        ...
                        <div className="lg:col-span-4 space-y-5 sm:space-y-6">
                            <div className="space-y-4">
                                <Link href="/" className="inline-flex items-center space-x-3 group">
                                    <div className="relative">
                                        <div className="w-10 h-10 sm:w-11 sm:h-11 bg-gradient-to-br from-[#c0a146] to-[#d4b55e] rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl group-hover:shadow-[#c0a146]/25 transition-all duration-300 group-hover:scale-110">
                                            <ShoppingBag className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
                                        </div>
                                        <div className="absolute -top-1 -right-1">
                                            <div className="w-3 h-3 bg-emerald-500 rounded-full border-2 border-background animate-pulse" />
                                        </div>
                                    </div>
                                    <div className="space-y-0.5">
                                        <span className="font-bold text-xl sm:text-2xl bg-gradient-to-r from-[#c0a146] via-[#d4b55e] to-[#c0a146] bg-clip-text text-transparent">
                                            EasyLife
                                        </span>
                                        <div className="flex items-center gap-1">
                                            <Badge variant="outline" className="text-[9px] px-1.5 py-0 border-[#c0a146]/30 text-[#c0a146]">
                                                TRUSTED
                                            </Badge>
                                        </div>
                                    </div>
                                ...
                                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed max-w-sm">
                                    Building the future of e-commerce with modern technology and exceptional user experience. Join thousands of successful sellers today.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-wrap items-center gap-4 sm:gap-6">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div className="text-left">
                                        <div className="flex items-center gap-1">
                                            {[1, 2, 3, 4, 5].map((i) => (
                                                <Star key={i} className="w-2.5 h-2.5 fill-[#c0a146] text-[#c0a146]" />
                                            ))}
                                        </div>
                                        <p className="text-xs text-muted-foreground">10K+ Happy Users</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3">
                                <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Follow Us</p>
                                <div className="flex space-x-2">
                        ...
                        <div className="lg:col-span-4 space-y-5">
                            <div className="space-y-3">
                                ...
                                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                                    Subscribe to our newsletter for exclusive offers, product updates, and industry insights.
                                </p>
                            </div>
